...
public class LabelItemLongClickListener implements OnItemLongClickListener{
	private Context ctx;
	...
	public LabelItemLongClickListener(Context ctx, List<Label> labelList,
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								if (which == 0) {
									...
									items[10] = "最后通信时间：" + label.getLastCommTime();
