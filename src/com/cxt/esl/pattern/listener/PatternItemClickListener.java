						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								// 更新
									...
									Intent intent = new Intent(ctx, PatternUpdateActivity.class);
											...
											new DialogInterface.OnClickListener() {
												...
												public void onClick(
													...
													try {
														...
														adapter = new PatternAdapter(ctx,
																R.layout.pattern_item, patternList);
														ListView listView = (ListView) ((Activity) ctx).findViewById(R.id.pattern_list);
