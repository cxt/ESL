...
@DatabaseTable(tableName="esls_goods_update")
public class GoodUpdateHistory implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8339327091733429370L;
	@DatabaseField(columnName = "goods_upd_id", generatedId = true, canBeNull = false)
	private int goodsUpdId;//int(11) NOT NULL AUTO_INCREMENT COMMENT '商品信息修改记录id',
	...
	@DatabaseField(columnName = "reason", defaultValue="")
	private  String reason;// varchar(200) DEFAULT NULL COMMENT '备注',
	...
	public int getGoodsUpdId() {
		return goodsUpdId;
	}
	public void setGoodsUpdId(int goodsUpdId) {
