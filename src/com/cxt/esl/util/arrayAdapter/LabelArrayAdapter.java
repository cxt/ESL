...
public class LabelArrayAdapter extends BaseAdapter {
	private List<Label> mList;
	private Context mContext;

	public LabelArrayAdapter(Context pContext, List<Label> pList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView!=null && mList != null)
		{
			...
			_TextView1.setText(mList.get(position).getEslId()+"");
		}
		return convertView;
	}
}
