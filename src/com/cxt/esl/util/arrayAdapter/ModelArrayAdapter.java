...
public class ModelArrayAdapter extends BaseAdapter {
	private List<Model> mList;
	private Context mContext;

	public ModelArrayAdapter(Context pContext, List<Model> pList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView!=null && mList != null)
		{
			...
			_TextView1.setText(mList.get(position).getModelName());
		}
		return convertView;
	}
}
